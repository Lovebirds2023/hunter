...
const CaseDetailScreen = ({ route, navigation }) => {
    ...
    const getPetTypeLabel = (value) => (
        String(value || 'dog').toLowerCase() === 'cat' ? 'Cat' : 'Dog'
    );
                                        ...
                                        {report.pet_type && (
                                            <View style={styles.detailItem}>
                                                ...
                                                <View style={styles.detailTextCol}>
                                                    ...
                                                    <Text style={styles.detailValue}>{getPetTypeLabel(report.pet_type)}</Text>
                                                </View>
                                            </View>
                                        )}
                                        {report.breed && (
                                            ...
                                            <View style={styles.detailItem}>
                                                ...
                                                <View style={styles.detailTextCol}>
                                                    <Text style={styles.detailLabel}>
                                                        {t('report.labels.pet_color', {
                                                            pet: getPetTypeLabel(report.pet_type),
                                                            defaultValue: `${getPetTypeLabel(report.pet_type)} Color`,
                                                        })}
                                                    </Text>
