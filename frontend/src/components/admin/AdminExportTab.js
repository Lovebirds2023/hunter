...
const EXPORT_TYPES = [
    ...
    { id: 'orders', label: 'Orders', icon: 'cart', description: 'Marketplace orders, status, and buyer details' },
    ...
    { id: 'dogs', label: 'Dog/Cat Registry', icon: 'paw', description: 'Pet database with breed, owner, and care records' },
